...
#if defined(__linux__) || defined(__WIN32__) || defined(__GP2X__) || defined(__GIZ__) || defined(__WIZ__) || defined(__PANDORA__) || defined(__MIYOO__)
...
void S9xDoDMA (uint8 Channel)
{
	...
	if (d->AAddressFixed && Memory.FillRAM [0x4801] > 0)
	{
		...
		{
	#if defined (__GP2X__) || defined (__GIZ__) || defined (__WIZ__) || defined(__PANDORA__) || defined(__MIYOO__)
